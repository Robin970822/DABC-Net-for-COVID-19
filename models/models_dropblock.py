...
from .block import DropBlock2D, resconv, slice_at_block

smooth = 0.001


def DABC(input_size=(10, 256, 256, 1), opt=Adam(lr=1e-4), load_weighted=None, is_trainable=True, drop_rate=0.5):
    slices = input_size[0]
    ...
    drop3 = TimeDistributed(DropBlock2D(drop_rate, 3))(conv3, training=is_trainable)  # 05/26
    ...
    drop4_1 = TimeDistributed(DropBlock2D(drop_rate, 3))(conv4_1, training=is_trainable)
    ...
    conv4_2 = TimeDistributed(DropBlock2D(drop_rate, 3))(conv4_2, training=is_trainable)
    ...
    drop4_3 = TimeDistributed(DropBlock2D(drop_rate, 3))(conv4_3, training=is_trainable)
