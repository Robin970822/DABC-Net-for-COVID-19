...
def _inverted_res_block(inputs, expansion, stride, alpha, filters, block_id, skip_connection, rate=1):
    ...
    in_channels = inputs.shape.as_list()[-1]  # if use in tf2.0
...
def Deeplabv3(weights=None, input_tensor=None, input_shape=(256, 256, 1), classes=1, backbone='mobilenetv2',
    ...
    if backbone == 'xception':
        ...
        x = Lambda(lambda xx: tf.image.resize_bilinear(
            xx, skip_size[1:3], align_corners=True))(x)
